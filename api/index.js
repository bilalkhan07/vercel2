import emailOtpSend from './_handlers/email-otp-send.js';
import emailOtpVerify from './_handlers/email-otp-verify.js';
import verifyLoginCredentials from './_handlers/verify-login-credentials.js';
import getDesigners from './_handlers/get-designers.js';
import getJobs from './_handlers/get-jobs.js';
import saveJob from './_handlers/save-job.js';
import registerDesigner from './_handlers/register-designer.js';
import updateDesignerPassword from './_handlers/update-designer-password.js';
import notifyNewJob from './_handlers/notify-new-job.js';
import notifyJobAccepted from './_handlers/notify-job-accepted.js';
import sendEmail from './_handlers/send-email.js';
import triggerPushNotification from './_handlers/trigger-push-notification.js';
import pushSubscribe from './_handlers/push-subscribe.js';
import pushVapidPublicKey from './_handlers/push-vapid-public-key.js';
import getCityAddresses from './_handlers/get-city-addresses.js';
